...
func TestDecodeSwapV3(t *testing.T) {
	...
	t.Run("Test DecodeMulticall1", func(t *testing.T) {
	...
	*/
	t.Run("Test DecodeMulticall2", func(t *testing.T) {
		version := "v3"
	...
	// Debuggin bug from multicall calling exactInputSingle
	/*

		
	*/
	t.Run("Test DecodeExactInputSingle2", func(t *testing.T) {
		...
		expectedArray := []string{""}

		if len(swapTransactions) != 1 {
			t.Errorf("Calls Data does not match expected value %v, got %v", expectedArray, swapTransactions[0].CallsData)
		}

		if expectedArray[0] != swapTransactions[0].CallsData[0] {
			t.Errorf("Calls Data does not match expected value %v, got %v", expectedArray[0], swapTransactions[0].CallsData[0])
		}

		if swapTransactions[0].MethodID != "414bf389" {
			t.Errorf("Method ID does not match expected value %v, got %v", "414bf389", swapTransactions[0].MethodID)
		}

		if swapTransactions[0].TokenPathFrom != "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2" {
			t.Errorf("Token Path From does not match expected value %v, got %v", "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", swapTransactions[0].TokenPathFrom)
		}

		if swapTransactions[0].TokenPathTo != "0xdac17f958d2ee523a2206206994597c13d831ec7" {
			t.Errorf("Token Path To does not match expected value %v, got %v", "0xdac17f958d2ee523a2206206994597c13d831ec7", swapTransactions[0].TokenPathTo)
		}

		if swapTransactions[0].AmountIn != "5000000000000000000" {
			t.Errorf("Amount In does not match expected value %v, got %v", "4563918244f4", swapTransactions[0].AmountIn)
		}

		if swapTransactions[0].AmountOut != "19625286871" {
			t.Errorf("Amount Out does not match expected value %v, got %v", "19625286871", swapTransactions[0].AmountOut)
		}
	})
